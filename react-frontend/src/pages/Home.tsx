        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-hide">
              {[
                {
                  img: "img/tortaClasica.png",
                  title: "Torta Clásica",
                  desc: "El sabor original que nos hizo famosos.",
                },
                {
                  img: "img/Bocaditos.jpg",
                  title: "Bocaditos Premium",
                  desc: "Variedad para tus eventos especiales.",
                },
                {
                  img: "img/Postres.png",
                  title: "Postres Individuales",
                  desc: "Un antojo dulce para cualquier momento.",
                },
                {
                  img: "img/TortaPersonalizada.png",
                  title: "Torta Personalizada",
                  desc: "Tu diseño, nuestro sabor.",
                },
              ].map((p) => (
                <div
                  key={p.title}
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <Link
                      to="/productos"
                      className="mt-auto inline-block px-4 py-2 bg-yellow-400 text-rose-900 font-semibold rounded-md hover:bg-yellow-300 transition"
                    >
                      Ver más
                    </Link>
                  </div>
